...
define(vlabel, [[// ]Vertex $1 = VCOUNT define($1, VCOUNT)define([VCOUNT], incr(VCOUNT))])
   ...
   define(D2, calc(0.5*D1))   //  inner cylinder diameter
   define(L2, calc(0.5*L1))  //  inner cylinder length
   ...
   define(NPS, 12) //how many cells in the square section
   define(NPD, 14) //how many cells from square section to perimeter
   define(NPT, 2) //how many cells in the thickness
   define(NPY, 300) // how many cells from top to bottom
