...
def write_patches(outfile, react):
    ...
    for n_imp in range(nimpellers):
        ...
        for i in range(nsplits):
            ...
            outfile.write(str(get_globalindex_of(i+1,hub_ci,zi_bottom, react))+" ")
    ...
    for zi in baff_volumes:
        ...
        for i in range(0,nsplits,2): #even numbers
            outfile.write("\t\t( ")
            outfile.write(str(get_baffle_point_of(i,hub_ci+1,zi_bottom, react))+" ")
            outfile.write(str(get_baffle_point_of(i,hub_ci+1,zi_top, react))+" ")
            outfile.write(str(get_baffle_point_of(i,hub_ci,zi_top, react))+" ")
            outfile.write(str(get_baffle_point_of(i,hub_ci,zi_bottom, react))+")\n")

            outfile.write("\t\t( ")
            outfile.write(str(get_globalindex_of(i,hub_ci+1,zi_bottom, react))+" ")
    ...
    for zi in only_stem_volumes:
        ...
        for i in range(nsplits):
            ...
            outfile.write(str(get_globalindex_of(i+1,poly_ci,zi_bottom, react))+" ")
...
if __name__ == "__main__":
    react = get_reactor_geom('stir_tank_mesh_templates/base_tank/tank_par.yaml')
