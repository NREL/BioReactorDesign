...
#include "sphericalDiffusiveMassTransfer_limited.H"
#include "phasePair.H"
...
{
    defineTypeNameAndDebug(sphericalDiffusiveMassTransfer_limited, 0);
...
Foam::diffusiveMassTransferModels::sphericalDiffusiveMassTransfer_limited::K() const
{

    Foam::tmp<Foam::volScalarField> K = 60*pair_.dispersed()/sqr(pair_.dispersed().d());
