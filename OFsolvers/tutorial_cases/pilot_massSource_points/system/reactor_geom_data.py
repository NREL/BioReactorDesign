...
#mesh ========
nr  = 50 #120	      # mesh points per unit radial length
nz  = 50 #240             # mesh points per unit axial length
...
bladepitch=[0.0,10.0*np.pi/180.0]

#curved bottom params
cb_center=[0.0,0.0,Z0+H/3]
edgep=[Dt/2,0.0,Z0]
...
for n_imp in range(nimpellers):
    ...
    reacthts.append(Z0 + C[n_imp] -  W*1.5)

    mrf_volumes.append(count)
