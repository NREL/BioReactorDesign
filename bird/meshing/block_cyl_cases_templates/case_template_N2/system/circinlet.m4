...
define(vlabel, [[// ]Vertex $1 = VCOUNT define($1, VCOUNT)define([VCOUNT], incr(VCOUNT))])
   ...
   define(D1, 1.25)   // outer cylinder diameter
   define(L1, 10.0)  // outer cylinder length
   ...
   define(NPS, 16) //how many cells in the square section
   define(NPD, 16) //how many cells from square section to perimeter
   define(NPY, 400) // how many cells from top to bottom
