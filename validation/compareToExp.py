...
fig = plt.figure()
plt.plot(refData['gh_exp17'][:,0], refData['gh_exp17'][:,1], 'o', color='b', label='exp. case 17')
plt.plot(refData['gh_exp19'][:,0], refData['gh_exp19'][:,1], 'o', color='r', label='exp. case 19')
plt.plot(refData['gh_exp17_ngu'][:,0], refData['gh_exp17_ngu'][:,1], color='b', label='Ngu et al.')
plt.plot(refData['gh_exp19_ngu'][:,0], refData['gh_exp19_ngu'][:,1], color='r',)
plt.plot(refData['gh_exp17_hassaniga'][:,0], refData['gh_exp17_hassaniga'][:,1], '--', color='b', label='Hissanaga et al.')
plt.plot(refData['gh_exp19_hassaniga'][:,0], refData['gh_exp19_hassaniga'][:,1], '--', color='r')
...
fig = plt.figure()
plt.plot(refData['xco2_exp17'][:,0], refData['xco2_exp17'][:,1], 'o', color='b', label='exp. case 17')
plt.plot(refData['xco2_exp19'][:,0], refData['xco2_exp19'][:,1], 'o', color='r', label='exp. case 19')
plt.plot(refData['xco2_exp17_ngu'][:,0], refData['xco2_exp17_ngu'][:,1], color='b', label='Ngu et al.')
plt.plot(refData['xco2_exp19_ngu'][:,0], refData['xco2_exp19_ngu'][:,1], color='r')
plt.plot(refData['xco2_exp17_hassaniga'][:,0], refData['xco2_exp17_hassaniga'][:,1], '--', color='b', label='Hissanaga et al.')
plt.plot(refData['xco2_exp19_hassaniga'][:,0], refData['xco2_exp19_hassaniga'][:,1], '--', color='r')
plt.plot(convertToMol(sim17['co2']), sim17['z'], linewidth=3, color='b', label='This work')
